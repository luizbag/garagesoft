...
class ServicosControllerTest < ActionController::TestCase
  ...
  test "should create servico" do
    assert_difference('Servico.count') do
      post :create, servico: { desc_curta: @servico.desc_curta, desc_longa: @servico.desc_longa, titulo: @servico.titulo }
    end
  ...
  test "should update servico" do
    patch :update, id: @servico, servico: { desc_curta: @servico.desc_curta, desc_longa: @servico.desc_longa, titulo: @servico.titulo }
    assert_redirected_to servico_path(assigns(:servico))
  end
